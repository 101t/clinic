...
<body>
	...
	<!--========== PROMO BLOCK ==========-->
	<section class="s-video-v2__bg" data-vidbg-bg="mp4: assets/include/media/mp4_video.mp4, webm: assets/include/media/webm_video.webm, poster: assets/include/media/fallback.jpg" data-vidbg-options="loop: true, muted: true, overlay: false">
	...
	<div class="container g-margin-t-o-150--xs">
	    <div class="center-block s-mockup-v1">
	        <img class="img-responsive" src="assets/img/mockups/devices-01.png" alt="Mockup Image">
	    </div>
	</div>
	<!-- End Mockup -->
	            ...
	            <div id="js__grid-portfolio-gallery" class="s-portfolio__paginations-v1 cbp">
	                ...
	                <div class="s-portfolio__item cbp-item motion graphic">
	                    <div class="s-portfolio__img-effect">
	                        <img src="assets/img/970x647/04.jpg" alt="Portfolio Image">
	                    </div>
	                ...
	                <div class="s-portfolio__item cbp-item logos graphic">
	                    <div class="s-portfolio__img-effect">
	                        <img src="assets/img/970x647/09.jpg" alt="Portfolio Image">
	                    </div>
	                    <div class="s-portfolio__caption-hover--cc">
	                        <div class="g-margin-b-25--xs">
	                ...
	                <div class="s-portfolio__item cbp-item logos motion">
	                    <div class="s-portfolio__img-effect">
	                        <img src="assets/img/970x647/05.jpg" alt="Portfolio Image">
	                    </div>
	                    <div class="s-portfolio__caption-hover--cc">
	                        <div class="g-margin-b-25--xs">
	                            <h4 class="g-font-size-18--xs g-color--white g-margin-b-5--xs">Operation Video</h4>
	                ...
	                <div class="s-portfolio__item cbp-item graphic">
	                    <div class="s-portfolio__img-effect">
	                        <img src="assets/img/970x647/06.jpg" alt="Portfolio Image">
	                    </div>
	                    <div class="s-portfolio__caption-hover--cc">
	                        <div class="g-margin-b-25--xs">
	                            <h4 class="g-font-size-18--xs g-color--white g-margin-b-5--xs">Operation Video</h4>
	                ...
	                <div class="s-portfolio__item cbp-item logos">
	                    <div class="s-portfolio__img-effect">
	                        <img src="assets/img/970x647/07.jpg" alt="Portfolio Image">
	                    </div>
	                    <div class="s-portfolio__caption-hover--cc">
	                        <div class="g-margin-b-25--xs">
	                            <h4 class="g-font-size-18--xs g-color--white g-margin-b-5--xs">Operation Video</h4>
	                ...
	                <div class="s-portfolio__item cbp-item motion graphic">
	                    <div class="s-portfolio__img-effect">
	                        <img src="assets/img/970x647/08.jpg" alt="Portfolio Image">
	                    </div>
	                    <div class="s-portfolio__caption-hover--cc">
	                        <div class="g-margin-b-25--xs">
	                            <h4 class="g-font-size-18--xs g-color--white g-margin-b-5--xs">Operation Video</h4>
	...
	<script type="text/javascript" src="assets/libs/vidbg.min.js"></script>
	<script type="text/javascript" src="assets/libs/waypoint.min.js"></script>
	<script type="text/javascript" src="assets/libs/counterup.min.js"></script>
	<script type="text/javascript" src="assets/libs/components/portfolio-4-col-slider.min.js"></script>
</body>
</html>