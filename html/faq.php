...
<body>
	...
	<!--========== PROMO BLOCK ==========-->
	<div class="js__parallax-window" style="background: url(assets/img/bg/06.jpg) 50% 0 no-repeat fixed;">
	...
	<script type="text/javascript" src="assets/libs/components/faq.min.js"></script>
</body>
</html>