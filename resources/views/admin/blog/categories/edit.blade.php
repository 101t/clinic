...
@section('title', 'Dr. Salim Balin | Edit Category')
@section('content')
<div class="m-grid__item m-grid__item--fluid m-wrapper">
    <div class="m-subheader ">
        <div class="d-flex align-items-center">
            <div class="mr-auto">
                <h3 class="m-subheader__title m-subheader__title--separator">{{ __("Edit Category") }}</h3>
                <ul class="m-subheader__breadcrumbs m-nav m-nav--inline">
                    ...
                    <li class="m-nav__separator">-</li>
                    <li class="m-nav__item">
                        <a href="{{ url('admin/blog/categories/'.$category->id.'/edit') }}" class="m-nav__link"><span class="m-nav__link-text">{{ __("Edit Category") }}</span></a>
                    </li>
                </ul>
            </div>
            <div>
                            ...
                            <div class="m-dropdown__body">
                                <div class="m-dropdown__content">
                                    <ul class="m-nav">
                                        ...
                                        <li class="m-nav__item">
                                            <a href="{{ url('admin/blog/categories') }}" class="m-nav__link"><i class="la la-reply"></i> {{ __('Go Back') }}</a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
    ...
    <div class="m-content">
        <div class="m-portlet m-portlet--mobile">
            <div class="m-portlet__body">
                ...
                {!! Form::model($category, ['method' => 'PUT', 'url' => "/admin/blog/categories/{$category->id}", 'class' => 'm-form', 'role' => 'form']) !!}
