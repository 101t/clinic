...
@section('title', 'Dr. Salim Balin | Create Category')
@section('content')
<div class="m-grid__item m-grid__item--fluid m-wrapper">
    <div class="m-subheader ">
        <div class="d-flex align-items-center">
            <div class="mr-auto">
                <h3 class="m-subheader__title m-subheader__title--separator">{{ __("Create Category") }}</h3>
                <ul class="m-subheader__breadcrumbs m-nav m-nav--inline">
                    ...
                    <li class="m-nav__separator">-</li>
                    <li class="m-nav__item">
                        <a href="{{ url('admin/blog/categories/create') }}" class="m-nav__link"><span class="m-nav__link-text">{{ __("Create Category") }}</span></a>
                    </li>
                </ul>
            </div>
            <div>
    ...
    <div class="m-content">
        <div class="m-portlet m-portlet--mobile">
            <div class="m-portlet__body">
                ...
                {!! Form::open(['url' => '/admin/blog/categories', 'class' => 'm-form', 'role' => 'form']) !!}
