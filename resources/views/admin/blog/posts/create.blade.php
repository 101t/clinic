...
@section('title', 'Dr. Salim Balin | Create Post')
@section('content')
<div class="m-grid__item m-grid__item--fluid m-wrapper">
    <div class="m-subheader ">
        <div class="d-flex align-items-center">
            <div class="mr-auto">
                <h3 class="m-subheader__title m-subheader__title--separator">{{ __("Create Post") }}</h3>
                <ul class="m-subheader__breadcrumbs m-nav m-nav--inline">
                    ...
                    <li class="m-nav__separator">-</li>
                    <li class="m-nav__item">
                        <a href="{{ url('admin/blog/posts/create') }}" class="m-nav__link"><span class="m-nav__link-text">{{ __("Create Post") }}</span></a>
                    </li>
                </ul>
            </div>
            <div>
    ...
    <div class="m-content">
        <div class="m-portlet m-portlet--mobile">
            <div class="m-portlet__body">
                ...
                {!! Form::open(['url' => '/admin/blog/posts', 'class' => 'm-form', 'role' => 'form', 'enctype' => 'multipart/form-data']) !!}
