...
@section('title', 'Dr. Salim Balin | Services')
@section('css')
@endsection
@section('content')
<div class="m-grid__item m-grid__item--fluid m-wrapper">
	<div class="m-subheader ">
		<div class="d-flex align-items-center">
			<div class="mr-auto">
				<h3 class="m-subheader__title m-subheader__title--separator">{{ __("Services") }}</h3>
				<ul class="m-subheader__breadcrumbs m-nav m-nav--inline">
					...
					<li class="m-nav__item">
						<a href="{{ route('admin:content_slider') }}" class="m-nav__link"><span class="m-nav__link-text">{{ __("Services") }}</span></a>
					</li>
				</ul>
			</div>
			<div>
...
<div class="modal" id="addeditmodal">
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
			<form id="addeditmodalform" action="{{ route('admin:content_services_manage') }}" method="POST" enctype="multipart/form-data">
				@csrf
...
<input type="hidden" name="url2action" value="{{ route('admin:content_services_manage') }}">
@endsection
@section('js')
<script type="text/javascript">
$("#content_parent_menu").addClass("m-menu__item--open").addClass("m-menu__item--expanded");
$("#services_menu").addClass("m-menu__item--active");
window.main_trans = {
	addservice: "{{ __('Add Service') }}",
	editservice: "{{ __('Edit Service') }}",
...
<script type="text/javascript" src="{{ asset('admin/scripts/content/services.js') }}"></script>
@endsection