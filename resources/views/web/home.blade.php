...
@section('title', 'Dr. Salim Balin | Home')
@section('css')
@endsection
@section('content')
            ...
            <div class="container g-ver-center--xs">
                <div class="row">
                    <div class="col-md-7">
                        ...
                        <a href="javascript:void(0)" class="text-uppercase s-btn s-btn--md s-btn--white-brd g-radius--50 g-padding-x-50--xs">Read More</a>
                    </div>
                </div>
            </div>
        </div>
        <div class="s-promo-block-v4 g-fullheight--xs g-bg-position--center swiper-slide" style="background: url('{{ asset('assets/img/bg/01.jpg')  }}');">
            ...
            <div class="row g-row-col--5 g-overflow--hidden js__masonry">
                ...
                <div class="col-xs-6 g-full-width--xs g-margin-b-10--xs g-margin-b-0--sm js__masonry-item">
                    <div class="wow fadeInDown" data-wow-duration=".3" data-wow-delay=".1s">
                        <img class="img-responsive" src="{{ asset('assets/img/400x550/03.jpg') }}" alt="Image">
                    </div>
                </div>
                <div class="col-xs-6 g-full-width--xs g-margin-b-10--xs js__masonry-item">
                    <div class="wow fadeInRight" data-wow-duration=".3" data-wow-delay=".3s">
                        <img class="img-responsive" src="{{ asset('assets/img/970x647/10.jpg') }}" alt="Image">
                    </div>
                </div>
                <div class="col-xs-6 g-full-width--xs js__masonry-item">
                    <div class="wow fadeInRight" data-wow-duration=".3" data-wow-delay=".5s">
                        <img class="img-responsive" src="{{ asset('assets/img/970x647/11.jpg') }}" alt="Image">
                    </div>
                </div>
            </div>
            <!-- End Masonry Grid -->
